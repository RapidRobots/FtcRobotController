...
@Autonomous(name="Auton LEFT PowerPlay HighPole 3 Cones", group="High")

public class AutonLeftPowerPlayHighPole3Cones extends LinearOpMode {

    private static final String TFOD_MODEL_FILE  = "powerplaycustom1205.tflite"; // "powerplaytfod_2.tflite";
    ...
    **/
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            moveArmUp(HIGH_POLE);   
            sendTelemetry(true);
            driveStraight(DRIVE_SPEED, 54.0, 0.0);
            ...
            turnToHeading(TURN_SPEED, -45.0);
            holdHeading(TURN_SPEED,  -45.0, 0.25);
            driveStraight(DRIVE_SPEED, -11.5, -45);
            moveArmDown(-1800);  
