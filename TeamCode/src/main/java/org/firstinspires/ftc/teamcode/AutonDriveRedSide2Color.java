...
@Autonomous(name="AutonDriveRedSide2Color")
public class AutonDriveRedSide2Color extends LinearOpMode {
...
*/
    public boolean detectGreen() {
        ...
        if (colorDist > 20) {
            greenCheck = true;
            telemetry.addData("green dist", colorDist);
        }
        return greenCheck;
    }
    public void thirdLevel() {
        ...
        armRotateMotor.setPower(0);//-0.32
...
*/
        ...
        for(int i = 4; i < 22  && opModeIsActive(); i++) {//18
        ...
        if (position == 1) {
            armRotateMotor.setPower(-0.55);//-0.75
            sleep(420);//220
            armRotateMotor.setPower(0);
            intake_motor.setPower(0.58);
            sleep(200);
            intake_motor.setPower(0);
